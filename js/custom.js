...
$(function () {
  ...
  $('.menu-icon button').on('click', function () {
    $('.desktop-header-duong').toggleClass('fadeInUp open active-menu');
  });

  $('main.content').on('click', function () {
    $('header.desktop-header-3, main.content, header.desktop-header-duong').removeClass('open');
  });

  $('.vertical-menu li a').on('click', function () {
    $('header.desktop-header-3, main.content, .desktop-header-duong').removeClass('fadeInUp open active-menu');
  });
